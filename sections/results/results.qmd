...
![Fig. 5.2a The pixel intensity versus brightness level for an exposure time of 0.01s](./images/brightness.png)

![Fig. 5.2b The pixel intensity versus brightness level for an exposure time of 0.1.](./images/brightness2.png)
...
![Fig. 5.3a The photodiode pixel intensity versus color code for a brightness level of 1.](./images/photodiodeTuple.png)


![Fig. 5.3b The photodiode pixel intensity versus brightness level for a color code of (0,0,0,255).](./images/photodiodeLevel.png)
...
![Fig. 5.5 The pixel intensity versus FITC concentration for varying exposure times.](./images/FITC.png)

![Fig. 5.6 Fluorescent image of FITC concentrations in a well plate](./images/FITC2.png)
...
### Physical Tests
The LSCI analysis script was run on images with a cream and water mixture running through the tube at flow rates of XX ml/hr, XX ml/hr, XX ml/hr, and XX ml/hr. The resulting speckle images, LSCI reproductions and intensity histograms are shown in Figures 5.10a, 5.10b, 5.10c, and 5.10d. 
